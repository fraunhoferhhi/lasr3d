...
sys.path.append(f"{PROJECT}/preprocess_cgsgan/3DDFA_V2/")
...
class KeypointDetectorDlib:
    def __init__(self):
        ...
        self.predictor = dlib.shape_predictor(
            f"{PROJECT}/models/shape_predictor_68_face_landmarks.dat"
        )
...
class FaceCropper:
    def __init__(self):
        cfg = {
            "arch": "mobilenet",
            "widen_factor": 1.0,
            "checkpoint_fp": f"{PROJECT}/models/mb1_120x120.pth",
            "bfm_fp": f"{PROJECT}/models/bfm_noneck_v3_slim.pkl",
            "param_mean_std_fp": f"{PROJECT}/models/param_mean_std_62d_120x120.pkl",
            "size": 120,
            "num_params": 62,
        }
...
class Masking:
    def __init__(self):
        ...
        self.modnet.load_state_dict(
            torch.load(f"{PROJECT}/models/modnet_photographic_portrait_matting.ckpt")
        )
        self.modnet.eval()
...
class Preprocessor:
    def __init__(self):
        self.keypoint_detector = KeypointDetectorDlib()
    ...
    def __call__(self, images, target_size):
        ...
        return masks, cam, cropped_images, keypoints
