...
from external.spectre.src.models.encoders import PerceptualEncoder
from external.spectre.src.utils.renderer import SRenderY, set_rasterizer
from external.spectre.src.models.encoders import ResnetEncoder
from external.spectre.src.models.FLAME import FLAME, FLAMETex
from external.spectre.src.utils import util
from external.spectre.src.utils.tensor_cropper import transform_points
...
class SPECTRE(nn.Module):
    ...
    def _create_model(self, model_cfg):
        ...
        # resume model
        model_path = f"{PROJECT}/models/spectre_model.tar"
