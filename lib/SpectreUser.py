...
from external.spectre.src.utils.util import tensor2video, tensor2image
from skimage.transform import estimate_transform, warp
from external.spectre.config import cfg as spectre_cfg
import numpy as np
from .SpectreModel import SPECTRE
import torch
import torch.nn as nn
from torch import Tensor
from typing import Union, List, Dict
from vive3D.util import tensor_to_image as t2i
...
class SpectreUser:
    def __init__(self, device="cuda:0"):
        ...
        spectre_cfg.model.flame_model_path = (
            f"{PROJECT}/models/generic_flame_model.pkl"
        )
        self.device = device
        ...
        self.landmarks_processor: LandmarkDetector = LandmarkDetector(device)
